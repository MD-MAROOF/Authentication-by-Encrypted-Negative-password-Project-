    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h2><span>Verify Your Password !!! <span class="style1"></span></span></h2>
          <div class="clr"></div>
         
          
          <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="uverifyp1.jsp">
            <p>&nbsp;</p>
            <p>
              <input type="submit" name="Submit" value="Verify Your Password" />
            </p>
          </form>
          <p> 
          </p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="dataOwnerMain.jsp">User  Main</a></li>
