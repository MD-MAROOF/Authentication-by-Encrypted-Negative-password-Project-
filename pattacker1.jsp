...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style8">Password Attacker(Create Negative Password) !!! </h2>
          <div class="clr"></div>
...
<form action="pattacker2.jsp" method="post" name="form1" id="form1">
<table border="0" align="center">
	<tr>
		...
		<td>&nbsp;</td>
       	...
       	<tr>
		<td width="223"><span class="style13">Enter User Name </span></td>
		<td width="245"><label> <input required name="t1"type="text"  size="40" /> </label></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td><span class="style13">Enter Attacked Password </span></td>
	...
	<tr>
		<td><div align="right"><input type="submit" name="Submit" value="Attack Password" /></div>		</td>
	</tr>
          </table>
          </form>		        
      </p>
